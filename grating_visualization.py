...
def compute_scores_by_angle(results, flash_windows, use_flash_peak, baseline_window=None):
    """
    ...
    for run in runs_data:
        ...
        t = run["t"]
        scores = compute_flash_scores(v_history, t, flash_windows, use_flash_peak=use_flash_peak, baseline_window=baseline_window)
...
def tuning_curve(
    ...
    scores_by_angle = compute_scores_by_angle(results, flash_windows, use_flash_peak=use_flash_peak, baseline_window=baseline_window)
